...
DOM_LIMIT = 5           # after n pages with new entries, disable expensive DOM check
...
############ Settings for Live Crawl ############

MAX_LIVE_RECORDS = 250  # total number of unique records crawled