...
logger = logging.getLogger(name="Wappalyzer")
...
class Fingerprint:
    ...
    def __init__(self, name: str, **attrs: Any) -> None:
        ...
        self.headers: Mapping[str, List[Pattern]] = self._prepare_headers(
            attrs['headers']) if 'headers' in attrs else {}
    ...
    @classmethod
    def _prepare_meta(cls, thing: Union[str, List[str], Dict[str, Union[str, List[str]]]]) -> Mapping[
        str, List[Pattern]]:
        # Ensure dict
    ...
    Union[str, List[str]]]]]) -> List[DomSelector]:
        ...
        if isinstance(thing, str):
            ...
            for cssselect, clause in thing.items():
                ...
                selectors.append(
                    DomSelector(cssselect, exists=_exists, text=_prep_text_patterns, attributes=_prep_attr_patterns))
        return selectors